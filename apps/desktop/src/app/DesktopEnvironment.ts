...
const make = Effect.fn("desktop.environment.make")(function* (
  ...
  const userDataDirName = isDevelopment ? "p3code-dev" : "p3code";
  const legacyUserDataDirName = isDevelopment ? "P3 Code (Dev)" : "P3 Code (Alpha)";
  ...
  return DesktopEnvironment.of({
    ...
    appUserModelId: Option.getOrElse(config.appUserModelIdOverride, () =>
      isDevelopment ? "com.collinrijock.p3code.dev" : "com.collinrijock.p3code",
    ),
    linuxDesktopEntryName: isDevelopment ? "p3code-dev.desktop" : "p3code.desktop",
    linuxWmClass: isDevelopment ? "p3code-dev" : "p3code",
